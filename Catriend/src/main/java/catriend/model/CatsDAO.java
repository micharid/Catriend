...
public class CatsDAO {
    ...
    public int InsertCat(final CatsDTO dto){
		...
		return template.update(sql, 
			...
			public void setValues(PreparedStatement psmt) throws SQLException {
				...
				psmt.setString(4, dto.getC_keyword());
				psmt.setInt(4, dto.getC_grade());
				psmt.setString(4, dto.getC_detail());
			}
		});
    }
    //고양이 비활성화
    ...
    public CatsDTO selectOne(int c_id){
		...
		return (CatsDTO)template.queryForObject(sql, 
				new BeanPropertyRowMapper<CatsDTO>(CatsDTO.class));
	}
    ...
    public List<CatsDTO> selectAll(Map<String, Object> map){
		...
		return (List<CatsDTO>)template.query(sql, 
				new BeanPropertyRowMapper<CatsDTO>(CatsDTO.class));
    }
}
