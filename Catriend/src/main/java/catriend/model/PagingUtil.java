...
public class PagingUtil {
	...
	public static String pagingImg(int totalRecordCount, int pageSize, int blockPage,
		...
		if(intTemp != 1){
			...
			pagingStr += "&nbsp;";
			pagingStr += "<a href='"+page+"nowPage="+(intTemp-blockPage)+"'><img src='./resources/images/paging2.gif'></a>";
		}
		//페이지표시 제어를 위한 변수
		int blockCount = 1;
		...
		if(intTemp <= totalPage){
			...
			pagingStr +="&nbsp;";
			pagingStr +="<a href='"+page+"nowPage="+totalPage+"'><img src='./resources/images/paging4.gif'></a>";
		}
