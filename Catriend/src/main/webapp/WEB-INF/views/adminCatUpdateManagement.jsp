					...
					<div class="col-lg-12 ">
						<div class="panel panel-default" style="width: 100%;">
							...
							<form action="catUpdateAction">
								...
								<div class="hline"></div>
								<p>
									<input type="hid den" value="${dto.c_index }" name="c_index" />
								<h4>
									이름 : ${dto.c_name}<input type="text" value="${dto.c_name}"
										name="c_name" />
								</h4>
								<h4>
									종류 : ${dto.c_type}<input type="text" value="${dto.c_type}"
										name="c_type" />
								</h4>
								<h4>
									생일 : ${dto.c_birthday}<input type="date"
										value="${dto.c_birthday}" name="c_birthday" />
								</h4>
								<h4>
									성별 : ${dto.c_gender}<input type="text" value="${dto.c_gender}"
										name="c_gender" />
								</h4>
								<h4>
									등급 : ${dto.c_grade}<input type="text" value="${dto.c_grade}"
										name="c_grade" />
								</h4>
								<h4>
									건강상태 : ${dto.c_health}<input type="text"
										value="${dto.c_health}" name="c_health" />
								</h4>
								<h4>
									키워드 : ${dto.c_keyword}<input type="text"
										value="${dto.c_keyword}" name="c_keyword" />
								</h4>
								<h4>
									세부사항 : ${dto.c_detail}<input type="text"
										value="${dto.c_detail}" name="c_detail" />
								</h4>
								<h4>
									보낸 날 : ${dto.c_sday}<input type="date" value="${dto.c_sday}"
										name="c_sday" />
								</h4>
								<h4>
									받은 날 : ${dto.c_eday}<input type="date" value="${dto.c_eday}"
										name="c_eday" />
								</h4>
