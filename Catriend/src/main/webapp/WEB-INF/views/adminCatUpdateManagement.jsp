                        ...
                        <form action="catUpdateAction">
                           ...
                           <table class="table table-bordered">
                              <tr class="text-center">
                                 <td colspan="2">
                                    <p style="font-size:1.4em;"><b>고양이 친구 프로필</b></p>
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_name}" name="c_name"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_type}" name="c_type"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="date" value="${dto.c_birthday}" name="c_birthday"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_gender}" name="c_gender"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_grade}" name="c_grade"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_health}" name="c_health"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_keyword}" name="c_keyword"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="text" value="${dto.c_detail}" name="c_detail"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="date" value="${dto.c_sday}" name="c_sday"/>
                                 </td>
                              </tr>
                              <tr>
                                 <td class="text-right">
                                 ...
                                 <td>
                                    <input type="date" value="${dto.c_eday}" name="c_eday"/>
                                 </td>
                              </tr>
                           </table>
