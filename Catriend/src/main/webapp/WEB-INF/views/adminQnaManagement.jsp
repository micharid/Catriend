				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="panel panel-default" style="width: 100%;">
							...
							<form name="Frm" action="qnasDeletes"
								...
								<div class="panel-body">
									<table class="table table-hover table-bordered">
										<tr style="text-align: center;">
											...
											<th style="width: 60%" class="info"><a href="adminQnaManagement?order=q_title&sort=${sort}&nowPage=0">제목</a></th>
											<th style="width: 10%" class="text-center info"><a href="adminQnaManagement?order=u_id&sort=${sort}&nowPage=0">아이디</a></th>
											<th style="width: 10%" class="text-center info"><a href="adminQnaManagement?order=q_answer&sort=${sort}&nowPage=0">답변여부</a></th>
											<th style="width: 10%;" class="text-center info"><a href="adminQnaManagement?order=q_date&sort=${sort}&nowPage=0">작성일</a></th>
										</tr>
