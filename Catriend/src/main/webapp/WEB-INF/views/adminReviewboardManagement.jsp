								...
								<div class="panel-body">
									<table class="table table-hover table-bordered">
										<tr style="text-align: center;">
											...
											<th style="width: 70%" class="info"><a href="adminReviewboardManagement?order=cb_title&sort=${sort}&nowPage=0">제목</a></th>
											<th style="width: 10%" class="text-center info"><a href="adminReviewboardManagement?order=u_id&sort=${sort}&nowPage=0">아이디</a></th>
											<th style="width: 10%;" class="text-center info"><a href="adminReviewboardManagement?order=cb_date&sort=${sort}&nowPage=0">작성일</a></th>
										</tr>
