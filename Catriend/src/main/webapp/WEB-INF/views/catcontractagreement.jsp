...
제1조 (목적)
이 약관은 캣렌드(이하 "회사")가 운영하는 캣렌드(이하 "캣렌드")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 상품 또는 용역을 거래하는 자 간의 권리, 의무 등 기타 필요사항, 회원과 회사간의 권리, 의무, 책임사항 및 회원의 서비스 이용절차 등에 관한 사항을 규정함을 목적으로 합니다.
 
제2조 (용어의 정의)
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. 캣렌드: 자유로운 상품 또는 용역(이하 "상품")의 거래를 위하여 회사가 제공하는 실시간 전자상거래 시스템과 그 운영을 위한 웹사이트를 말합니다.
...
가. 일반회원(구매고객): 캣렌드에서 상품구매 및 구매와 관련하여 제공되는 서비스를 이용할 수 있는 회원을 말합니다. 일반회원은 개인구매회원과 사업자구매회원으로 구분됩니다.
a. 개인구매회원: 구매만을 목적으로 하는 회원으로 만 14세 이상이면 누구나 가입할 수 있음(국내에 거주하는 외국인 포함)
b. 사업자구매회원: 구매를 목적으로 사업자 정보로 등록한 회원
나. 셀러회원(구매판매고객): 캣렌드에서 상품 구매 및 관련 서비스와 판매회원약관(이하 "판매이용약관")상의 서비스를 이용할 수 있는 회원을 말합니다. 셀러회원은 개인셀러회원과 사업자셀러회원으로 구분됩니다.
...
14. 캐시: 캣렌드에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유로 환불을 요청했을 때 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려워 회사가 회원에게 환불해야 하는 현금 환불수단으로 활용되는 정보를 말합니다.
...
20. 분쟁조정센터: 캣렌드를 통한 거래에서 분쟁이 발생하면 판매자와 구매자가 자율적으로 해결하는 것이 원칙이지만, 분쟁의 합리적이고 원활한 조정을 위하여 예외적으로 회사가 설치·운영하는 분쟁조정기구를 말합니다.
② 제1항에서 정의되지 않은 용어의 의미는 관련 법령 및 일반적인 거래관행을 따릅니다.
 
제3조 (적용 범위 및 효력 우선순위)
① 이 약관에서 제1장(총칙), 제3장(기타사항)은 전체 서비스에 적용되며, 제2장은 캣렌드(통신판매중개) 서비스에 구분하여 적용됩니다.
② 제1장 및 제3장의 규정과 개별서비스인 제2장의 규정이 상충할 때에는 개별서비스 관련 규정(제2장)이 전체서비스 관련 규정(제1장 및 제3장)보다 우선적인 효력을 갖습니다.
 
제4조 (약관의 명시, 효력 및 변경)
① 회사는 정의된 약관을 이용자가 알 수 있도록 회사의 서비스가 제공되는 인터넷 사이트 (catriend)의 첫 화면에 게시합니다.
...
② 회사는 필요하면 특정 서비스에 적용될 사항(이하 “개별약관”)을 정하여 이를 캣렌드 등을 통하여 공지할 수 있습니다.
③ 회사는 필요하면 서비스 이용과 관련된 세부적인 내용(이하 "이용정책")을 정하여 이를 캣렌드 등을 통하여 공지할 수 있습니다.
④ 개별약관이나 이용정책의 변경이 있으면 회사는 변경 내용의 효력발생일 7일 이전에 캣렌드를 통하여 해당 변경 사항을 공지합니다.
...
⑥ 캣렌드에서 제공하는 서비스를 통하여 거래가 성사 되었을 때 회사는 판매자와 구매자 간에 물품거래와 배송 등의 이행과 관련하여 필요한 범위 내에서 구매자의 개인정보를 판매자에게 제공합니다.
...
8. 캣렌드 구매/판매이용약관의 적용을 받는 자가 해당 약관을 위반한 경우
...
마. 회원이 이 약관에 위배되는 행위를 하거나 이 약관에서 정한 해지사유가 발생한 경우(캣렌드 판매회원 약관의 적용을 받는 자가 해당 약관을 위반한 경우 포함)
...
제13조 (서비스 기간과 중단)
① 회원의 서비스 기간은 캣렌드에 서비스를 신청하여 이용승낙을 받은 날로부터 서비스 이용계약을 해지할 때까지 입니다.
...
제14조 (서비스 이용료)
① 회사는 캣렌드의 일부 특정 서비스나 기능을 제공할 때 이용료를 부과할 수 있습니다
...
② 마일리지는 캣렌드에서 사용되는 지불수단으로 이를 이용해 주문결제, 대금지급을 할 수 있으며, 1마일리지는 1원의 의미가 있습니다.
③ 캐시는 회사가 운영하는 선불전자지급수단인 오케이캐쉬백포인트로 전환 가능하며, 최소 일천원(￦1,000원)부터 충전할 수 있고 캣렌드가 제공하는 결제수단 중 현금입금으로만 충전할 수 있습니다.
...
⑦ 본 조 제6항의 기한과 이용방법은 공지내용과 캣렌드 홈페이지에서 확인할 수 있습니다.
...
⑩ 캣렌드에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유가 발생하면 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려우면 회사는 회원에게 환불수단으로 캐시를 이용하여 회원에게 환불해 줄 수 있습니다. 이 때, 캐시는 현금출금만 가능하며, 캐시 1원은 현금 1원의 의미가 있습니다.
...
④ 본 조 제3항에 언급된 회사의 사용권은 캣렌드 서비스를 운영하는 동안에만 확정적으로 유효합니다.
...
⑦ 이용자가 캣렌드를 이용하여 얻은 정보를 회사의 승낙 없이 복제, 송신, 출판, 배포, 방송, 기타 방법으로 이용하거나 제3자에게 이용하게 할 때 그에 대한 책임은 이용자 본인에게 있습니다.
⑧ 회원은 캣렌드 내에서 자신의 저작권이 침해되면 회사가 운영하는 신고센터 제도를 이용하여 자신의 정당한 권리를 보호받을 수 있습니다.
...
5. 기타 제1호 내지 제4호에 준하는 중대한 사유로 말미암아 회사가 제공하는 캣렌드 서비스의 원활한 진행을 방해하는 것으로 판단되는 경우
...
1. E-Commerce 서비스: 회사가 인터넷사이트(catriend)를 통하여 회원 간에 상품의 매매가 이루어질 수 있도록 온라인 거래장소를 제공하는 서비스 및 관련 부가서비스를 말합니다.
가. 판매 관련 업무지원 서비스
나. 구매 관련 지원 서비스
...
② 회사는 캣렌드를 통하여 이루어지는 구매자와 판매자 간의 거래와 관련하여 판매의사 또는 구매의사의 존부 및 진정성, 등록 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성, 구매자 또는 판매자가 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 또는 적법성 등 일체를 보증하지 않습니다. 다만, 등록된 상품 관련 정보가 법규 위반이나 저작권 침해가 명백한 경우, 또는 저작권 등 권리를 침해받았다고 주장하는 자가 그 침해의 정지ㆍ예방을 요청하는 경우 회사는 당사자간의 분쟁이 해결되어 권리관계가 명확해질 때까지 해당 상품에 대한 삭제, 수정 또는 미노출 처리할 수 있습니다.
...
④ 구매자는 캣렌드 셀러회원과 1:1 채팅을 위해 회사가 제공하는 메신저 서비스를 이용할 수 있습니다. 해당 서비스를 통한 대화 내용은 대화 당사자가 동시에 대화 진행 불가 시 대화 내용 유지 등 원활한 서비스 제공을 위해 최대 7일간 암호화되어 저장되었다가 자동으로 삭제되며 회사는 해당 서비스 이용 목적 외 이를 사용하지 않습니다.
...
⑭ 회사가 구매자의 서비스 이용 편의를 높이기 위해 제휴업체로부터 정보를 제공받아 게재하거나 제3자가 제공하는 방식으로 캣렌드 사이트 내 또는 링크 방식으로 참조용 정보나 콘텐츠를 제공할 수 있으며, 구매자는 상품 구매 때 자신의 판단과 책임으로 결정하여 구매하여야 합니다.
...
② 결제대금 보호 서비스는 캣렌드에서 구매하는 모든 상품에 적용 됩니다.
...
⑪ 확인된 거래가 취소되어 결제대금을 환불할 경우는 회사는 거래가 취소된 날로부터 2영업일 이내에 구매자에게 환불에 필요한 조치를 합니다. 신용카드로 결제했을 때는 환불을 요청한 즉시 결제 승인이 취소되고, 캣렌드 선불전자지급수단으로 결제한 거래가 취소되었을 때에는 즉시 환불조치를 합니다.
...
⑩ 제3자에게 재판매하기 위한 목적으로 회사가 제공하는 혜택을 부당하게 이용하는 행위(다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 등으로 캣렌드 할인쿠폰 발행을 유도한 후 해당 쿠폰을 적용하여 구매하는 행위 등)는 금지되며, 재판매 목적의 거래행위가 확인된 경우 회사는 해당 회원에 대하여 서비스이용제한, 이용계약의 해지 등의 조치를 취할 수 있으며, 이러한 행위로 손해가 있을 경우 배상을 청구할 수 있습니다.
...
② 해외쇼핑 캣렌드 내에서의 판매자는 글로벌 셀러에 한정합니다.
...
⑥ 해외쇼핑 캣렌드에서 판매되는 상품 가격에는 관세와 부가세(이하 ’관부가세’)가 포함되어 있을 수 있으며, 관부가세가 포함되어 있지 않은 상품에도, 상품 종류, 가액, 구매 목적(국내 판매 목적 구매 등) 등에 따라 추후 관부가세가 부과될 수 있으며, 이와 관련하여 관세청으로부터 수입신고 절차 및 관부가세 납부 절차의 통지를 받으실 수 있습니다.
⑦ 수입대행자인 글로벌셀러가 관세법에 따라 제6항의 수입신고를 대행하는 경우 관세법 등 관련 법령에 따라 회사는 글로벌셀러가 수입을 대행하는 데 필요한 구매자의 통관정보를 글로벌셀러로부터 위탁 받아 수집할 수 있습니다.
⑧ 본 조에서 달리 규정된 사항을 제외하고는, 해외쇼핑 캣렌드를 이용하는 데도 이 약관의 제반 내용이 동일하게 적용됩니다.
...
제31조 (기타 조항)
① 회사는 필요하면 특정 서비스나 기능의 전부 또는 일부를 캣렌드 사이트를 통해 미리 공지한 후 일시적 또는 영구적으로 수정하거나 중단할 수 있습니다.
② 각 당사자는 상대방의 서면 동의 없이 이 약관상의 권리와 의무를 제3자에게 양도하거나 처분할 수 없습니다.
③ 이 약관과 관련하여 당사자 간의 합의에 따라 추가로 작성된 계약서, 협정서, 통보서 등과 회사의 정책변경, 법령의 제·개정 또는 공공기관의 고시나 지침 등에 따라 회사가 캣렌드 사이트를 통해 공지하는 내용도 이용계약의 일부를 구성합니다.
