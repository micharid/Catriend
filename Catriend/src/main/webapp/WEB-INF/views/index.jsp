...
<!-- top e -->
        ...
        <div class="row pad-set">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="just-txt-div" style="margin:10px 0 0 0">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  <div class="just-txt-div">
                      <br />
                 <iframe style="width:555px; height:300px;"src="https://www.youtube.com/embed/Xz6yBbBRr8Y" frameborder="0" allowfullscreen></iframe>
