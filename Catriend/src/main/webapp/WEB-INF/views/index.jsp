...
<!-- bottom e -->
    ...
    <section id="about" class="container">
      <div class="row">
       ...
       <div id="blue" style="width:1170px;">
					...
					<center>
						<h3 style=" font-size: 20px; line-height: 1.428571429; color: #fff; padding:10px;">관련 영상</h3>
					</center>
				...
				<div class="row pad-set">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<div class="just-txt-div">
							<iframe width="555" height="300" src="https://www.youtube.com/embed/jPf0X0QclXE" frameborder="0" allowfullscreen></iframe>
						</div>
    ...
    <section id="portfolio">
     ...
     <div id="blue" style="margin-top:60px;">
					...
					<center>
						<h3 style=" font-size: 20px; line-height: 1.428571429; color: #fff; padding:10px;">후기 게시판</h3>
					</center>
          ...
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/1.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/2.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/3.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/4.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/5.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
          <div class="col-md-4">
            ...
            <div class="thumbnail">
              ...
              <img src="./resources/KapukAlas/img/gal/6.jpg" width="100%" height="100%">
            </div>
            </a>
          </div>
        </div>
        	<center>
        		...
        		<a href="" class="btn btn-primary btn-lg" role="button">후기 게시판 바로가기</a>
        	</center>
      </div>
    </section>
