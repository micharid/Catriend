	...
	<div class="container">
		<div class="row">
			<div id="blue" style="margin-top: 60px;">
				<center>
					<h3
						style="font-size: 20px; line-height: 1.428571429; color: #fff; padding: 10px;">MY
						PAGE</h3>
				</center>
			</div>
						...
						<div class="panel-body text-center" style="cursor: pointer">
							<div class="tab1img">
								<img class="center-block"
									src="./resources/assets/img/setting.png"
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					<a href="myfreeboardhistory">
						<div class="panel-body text-center" style="cursor: pointer">
							<div class="tab2img">
								<img class="center-block" src="./resources/assets/img/list.png"
									style="width: 96px ! important; height: 96px ! important;">
							</div>
				...
				<div class="panel panel-default">
					<a href="mycontracthistory?nowPage=1">
						<div class="panel-body text-center" style="cursor: pointer">
							<div class="tab3img">
								<img class="center-block"
									src="./resources/assets/img/contract.png"
									style="width: 96px ! important; height: 96px ! important;">
							</div>
			...
			<div class="col-md-4">
				<div class="panel panel-default">
					<a href="myqnahistory">
						<div class="panel-body text-center" style="cursor: pointer">
							<div class="tab4img">
								<img class="center-block" src="./resources/assets/img/faq.png"
									style="width: 96px ! important; height: 96px ! important;">
							</div>
