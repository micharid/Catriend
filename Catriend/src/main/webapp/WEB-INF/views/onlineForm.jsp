                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <h3>이 문제의 점수로 등급이 매겨집니다.<h3>
                        </div>
                        <div class="panel-body">
                           <h4>다음중 고양이과 동물이 아닌것음?</h4>
                           <p><input type="radio" value="0" />삵</p>
                           <p><input type="radio" value="0" />치타</p>
                           <p><input type="radio" value="5" />곰</p>
                           <p><input type="radio" value="0" />퓨마</p>
                           
                           <hr />
                           
                           <h4>다음중 고양이가 만지면 싫어하는 부위는?</h4>
                           <p><input type="radio" value="0" />목 뒷덜미</p>
                           <p><input type="radio" value="0" />턱</p>
                           <p><input type="radio" value="5" />배</p>
                           <p><input type="radio" value="0" />엉덩이</p>
