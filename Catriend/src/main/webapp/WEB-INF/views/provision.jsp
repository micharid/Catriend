...
제1조(목적)
이 약관은 Cat'riend(이하 "단체"라 한다) 홈페이지 에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. 
...
(시행일) 이 약관은 2014년 5월 1일부터 시행합니다.
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=10 readonly class=ed>&#039;Cat'riend&#039;은 (이하 &#039;단체&#039;는)
